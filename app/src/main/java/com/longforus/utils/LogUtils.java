...
public final class LogUtils {
    ...
    private static void log(final int type,final String tag,final Object... contents) {
        ...
        if (sLogCallBack != null) {
            sLogCallBack.onLog(type,tagAndHead[0],body);
        }
    ...
    private static String[] processTagAndHead(String tag) {
        if (!sTagIsSpace && !sLogHeadSwitch) {
            ...
            if (sLogHeadSwitch) {
                String head = new Formatter().format("%s, %s(%s.java:%d)",Thread.currentThread().getName(),targetElement.getMethodName(),className,targetElement.getLineNumber())
                                             .toString();
    ...
    private synchronized static String formatNow(Date now) {
    ...
    public interface LogCallBack {
        void onLog(int v,String tag,String content);
    }
    ...
    public static class Builder {
        ...
        public String toString() {
            return "switch: " + sLogSwitch + LINE_SEP + "console: " + sLog2ConsoleSwitch + LINE_SEP + "tag: " + (sTagIsSpace ? "null" : sGlobalTag) + LINE_SEP + "head: " +
                sLogHeadSwitch + LINE_SEP + "file: " + sLog2FileSwitch + LINE_SEP + "dir: " + (dir == null ? defaultDir : dir) + LINE_SEP + "border: " + sLogBorderSwitch +
